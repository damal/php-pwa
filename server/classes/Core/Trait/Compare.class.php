...
Описание: Основные функции: работа с сопоставлениями данных и правилами
Версия	: 1.0.0/ALPHA
Дата	: 2012-05-13
...
trait Core_Trait_Compare{
	 ...
	 * 			"BOOL"			- БУЛЕВО ЗНАЧЕНИЕ TRUE FALSE, если empty(attr) != empty(value) - вернет FALSE, иначе - TRUE
	...
	static public function compareRuleElement($attr, $value, $operator='='){
		...
		switch(strtoupper($operator)){
			...
			#БУЛЕВО ЗНАЧЕНИЕ TRUE FALSE, если empty(attr) != empty(value) - вернет FALSE, иначе - TRUE
			case 'BOOL': return (empty($attr) == empty($value));
